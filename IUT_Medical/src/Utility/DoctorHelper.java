...
public class DoctorHelper {
    public static String[] specializations = {
            ...
            "Gastroenterology", "Dermatology", "Psychiatry", "Urology", "Ophthalmology",
            "ENT (Otolaryngology)", "Endocrinology", "Rheumatology", "Nephrology",
            "Pulmonology", "Hematology", "Allergy and Immunology", "Emergency Medicine",
    ...
    public static List<String> getSpecializations(int count) {
        List<String> specializationsList = new ArrayList<>();
        Random random = new Random();
        for (int i = 0; i < count; i++) {
            specializationsList.add(specializations[random.nextInt(specializations.length)]);
        }
    ...
    public static List<String> getEmails(List<String> names) {
        ...
        for (String name : names) {
            ...
            processedName = processedName.replace("dr.", "");
